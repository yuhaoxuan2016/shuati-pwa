...
/* ===== 记录码 ===== */
.record-box { margin: 14px 0 10px; padding: 12px 14px; background: #f0fdf4; border: 1px dashed #16a34a; border-radius: var(--radius-md); }
.record-label { font-size: 12px; color: #15803d; margin-bottom: 6px; }
.record-value { font-size: 22px; font-weight: 800; letter-spacing: 2px; color: #15803d; cursor: pointer; user-select: all; font-family: monospace; }
...
.review-btn { padding: 8px 16px; background: #16a34a; color: #fff; border: none; border-radius: var(--radius-md); font-size: 13px; font-weight: 500; cursor: pointer; }
...
.hi-score { font-size: 24px; font-weight: 700; color: #4f46e5; flex-shrink: 0; }
